...
class ReportHandler(Handler):
    ...
    def _process_oldest_tick(self) -> (List[PowerReport], List[FormulaReport]):
        ...
        try:
            system_power = model.compute_global_power_estimation(global_core)
            ...
            model.learn(rapl_power, global_core)
            return power_reports, formula_reports
        ...
        for target_name, target_report in hwpc_reports.items():
            ...
            target_power, target_ratio = model.compute_target_power_estimation(rapl_power, global_core, target_core)
